 ...
 * playCloseSound()
 *
 * Intentionally silent. Close actions keep their visual feedback without
 * claiming the system audio output device.
 */
    ...
    <div class="deferred-item" data-deferred-id="${safeId}">
      ...
      <div class="deferred-info">
        <a href="${safeUrl}" target="_blank" rel="noopener" class="deferred-title" title="${safeTitle}">
          <img src="${escapeHtml(faviconUrl)}" alt="" style="width:14px;height:14px;vertical-align:-2px;margin-right:4px">${safeTitle}
        </a>
...
function renderArchiveItem(item) {
  ...
  return `
    <div class="archive-item">
      ...
      <span class="archive-item-date">${safeAgo}</span>
    </div>`;
}
